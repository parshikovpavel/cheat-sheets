...
- нужно начать с написания тестовых примеров: для того чтобы учесть все крайние случаи. Также эти тестовые примеры можно рассматривать, как способ решения задачи через тестирование (TDD).
