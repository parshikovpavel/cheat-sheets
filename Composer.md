...
Packagist ([https://packagist.org/](https://vk.com/away.php?to=https%3A%2F%2Fpackagist.org%2F&cc_key=)) –официальный каталог Composer пакетов PHP-сообщества. Каталог помогает искать пакеты по ключевым словами, и хранит информацию о пакетах, в т.ч. ссылку на Github. 

Имя каждого пакета имеет вид:

имя_производителя/имя_пакета

[yiisoft/](https://packagist.org/packages/yiisoft/)yii2
...
В этом свойстве указывается список пакетов, которые обязательно требуются для данного пакета (или проекта). 
...
o    папка vendor с пакетами, 

o    файл vendor/autoload.php.
