...
У Git есть три основных состояния, в которых могут находиться ваши файлы: *modified* (изменён), *staged* (индексирован) и *committed* (зафиксирован):

- *Modified* – файлы, которые вы поменяли, но ещё не сделали для них *commit* в *database*.
- *Staged* — *modified* файл, который вы пометили для включения в следующий *commit snapshot* в его текущей версии.
- *Committed* – файл, сохраненный  в вашей *local database*.
