...
* Коллекции состоят из *документов* (аналог строки). *Документ* хранит информацию о полях, которые находятся внутри него. Разные *документы* могут иметь различные наборы полей.  Документ описывается в форме JSON объекта.
