...
Write consern (проблема записи) – описывает уровень подтверждения, запрошенный у MongoDB для операций записи.
...
-  `<custom write concern name>` – требует, чтобы операции записи распространнились на определенные тегированные сервера.
