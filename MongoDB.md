...
<u>Сопоставление по всему массиву целиком</u>
...
<u>Сопоставление на вхождение *нескольких* элементов</u>
...
```
 ...
 <u>Сопоставление на вхождение *одного* элемента</u>
...
Аналогично, можно использовать [query operators](#query-filter-document), которые должны выполняться хотя бы для одного элемента массива. Например, проверить, что хотя бы один элемент массива меньше 200:
