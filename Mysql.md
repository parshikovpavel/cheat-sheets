...
- масштабирование системы, когда операций записи мало, а операций чтения много. При этом запросы на чтение распределяются между несколькими *slav*'ами. Балансирование может выполняться либо на уровне приложения, либо через *DNS- round-robin*.
