...
Оптимистичные блокировки хорошо работают в условиях низкого *concurrency* (низкая RPS)

При высоких RPS слишком часто происходят конфликты и нужно переходить на пессимистичные блокировки
...
Также смотреть [измерение производительности для Go приложений](go/pprof.md#измерение-производительности)
