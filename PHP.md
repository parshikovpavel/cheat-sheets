...
<u>Вариантность (*variance*) или совместимость присваивания (*assignment compatibility*) типов</u> – это существующие ограничения и разрешения на возможность подставлять  значение одного типа вместо другого типа, причем эти типы связаны иерархией наследования. 
...
До версии 7.4 PHP поддерживал только *invariant* типы параметров и *invariant* типы возвращаемого значения. 

![invariance](https://parshikovpavel.github.io/img/php/invariance.png)

<u>Ковариантность (*covariance*) типа</u> – это ограничение на подстановку надклассов и возможность на подстановку подклассов. 

В PHP существует ковариантность типа возвращаемого значения (*covariant return type*) в методах дочернего класса (предусловия могут быть ослаблены в подклассах, PHP7.2):
...
<u>Контравариантность (*contravariance*) типа</u> – это ограничение на подстановку подклассов и возможность на подстановку надклассов. 

В PHP существует контравариантность типа параметра (*contravariant parameter type*) в методах дочернего класса:
