...
Их можно использовать тогда, когда нужен одноразовый класс и создавать полноценный класс, а потом его объект не имеет смысла:
...
- Возможности *generator*'ов ([1](#generator))
  ...
  - Делегация генератора[ ](http://php.net/manual/ru/migration70.new-features.php#migration70.new-features.generator-delegation)yield from
...
Преобразование callable в [Closure](http://php.net/manual/ru/class.closure.php) с помощью [Closure::fromCallable()](http://php.net/manual/ru/closure.fromcallable.php)[ ¶](http://php.net/manual/ru/migration71.new-features.php#migration71.new-features.convert-callables-to-closures)
...
### Добавлена возможность перегружать абстрактные функции ([RFC](https://wiki.php.net/rfc/allow-abstract-function-override))
...
Если [object](http://php.net/manual/ru/language.types.object.php) преобразуется в [object](http://php.net/manual/ru/language.types.object.php), он не изменяется. Если значение другого типа преобразуется в [object](http://php.net/manual/ru/language.types.object.php), создается новый экземпляр встроенного класса *stdClass*. Массивы преобразуются в [object](http://php.net/manual/ru/language.types.object.php) с именами полей, названными согласно ключам массива и соответствующими им значениям, за исключением числовых ключей, которые не будут доступны пока не проитерировать объект.
...
### Вызов Count с параметром, который нельзя посчитать ([RFC](https://wiki.php.net/rfc/counting_non_countables))
...
### Возможность расширения типа параметра ([RFC](https://wiki.php.net/rfc/parameter-no-type-variance))
...
### Добавлена возможность указывать запятую в конце группированных неймспейсов ([RFC](https://wiki.php.net/rfc/list-syntax-trailing-commas))
...
### Добавлен отладчик PDO Prepared statements ([RFC](https://wiki.php.net/rfc/debugging_pdo_prepared_statement_emulation))
