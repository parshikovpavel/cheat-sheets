...
Алгоритм изменении значения переменной `$a` (с `refcount > 1`):

-  скопировать подчиненную структуру-значение
-  сделать изменения в копии
-  связать `zval` переменной `$a`  с копией подчиненной структуры-значения.
