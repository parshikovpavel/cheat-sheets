...
Система кэширования обязана отдавать данные без какой-либо модификации, причем тип возвращаемых данных должен в точности совпадать с типом помещенных в кэш значений. То есть не допускается ситуация, когда в кэш помещается строка "5", а на выходе получается числовое значение 5.

[                                                    ](https://vk.com/id2733257)

[Павел](https://vk.com/id2733257) [14:37](https://vk.com/im?sel=2733257&msgid=61704)
