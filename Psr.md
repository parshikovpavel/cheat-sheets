...
*/**  \* This is a summary.  \*/* **class** ParentClass
 {
 }

 */**  \* @inheritDoc  \*/* **class** ChildClass **extends** ParentClass
 {
 }
...
[Павел](https://vk.com/id2733257) [12:28](https://vk.com/im?sel=2733257&msgid=64293)

 

ы можете использовать тег @var для документирования «Тип» следующих «Структурных элементов»:

 Константы, как классовые, так и глобальныесвойстваПеременные, как глобальные, так и локальные

[     ](https://vk.com/id2733257)

[Павел](https://vk.com/id2733257) [13:04](https://vk.com/im?sel=2733257&msgid=64294)

 

Другим примером является документирование переменной в foreach явно; многие IDE используют эту информацию, чтобы помочь вам с автозаполнением:
