...
Распечатайте основную информацию о предоставленном GEM, такую как домашняя страница, версия, путь и резюме.

## Параметры

- `--path`

  Распечатать путь данного драгоценного камня
