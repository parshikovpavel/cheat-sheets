...
Часть зависимостей может мокаться.
...
- Очень нестабильны
- Дают уверенность, что пользователь все видит правильно. Проверив один E2E тест, можно быть уверенным в результатах работы всей логики приложения на всех уровнях архитектуры
